...
Изобрази Технологический роадмап «Будущее 2.0» на 2 года в форме mermaid gantt диаграммы для внесения изменений согласно плана:

#### Отказываемся от технологий

1. Отказываемся от технологий от Apache Camel (Common Bus)
	* переход на **Apache Kafka** в качестве высокопроизводительной, отказоустойчивой шины событий с возможностью долговременного хранения и потоковой обработки
	
2. Отказываемся от Power Builder (Клиентский интерфейс оператора)
	Вместо Power Builder целесообразно разработать современный веб-интерфейс на **React**.
